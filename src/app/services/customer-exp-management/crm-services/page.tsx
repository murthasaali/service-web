...
export const metadata: Metadata = {
	...
	description:
		'Professional CRM implementation and integration services. Align sales, support, and marketing teams around a single view of the customer with Salesforce, HubSpot, or Zoho.',
	keywords: [
		'CRM implementation',
		'CRM services',
	...
	alternates: {
		canonical:
			'https://aibizmod.com/services/customer-exp-management/crm-services',
	},
	openGraph: {

...
const serviceCards: ServiceCard[] = [
  {
    ...
    imageAlt: "Professional whiteboard session outlining CRM database customization stages.",
  ...
  },
  {
    ...
    imageAlt: "Helpdesk support specialist typing customer support tickets on a computer.",
  ...
  },
  {
    ...
    imageAlt: "Helpdesk shared inbox view demonstrating omnichannel customer engagement integration.",
  ...
  },
  {
    ...
    imageAlt: "Looker Studio customer analytics and customer retention dashboard layout.",
  ...
  },
  {
    ...
    imageAlt: "Close-up of server motherboard circuit representing automated customer support workflows.",
  ...
  },
  {
    ...
    imageAlt: "Operations center screen demonstrating customer experience technology roadmaps and planning.",

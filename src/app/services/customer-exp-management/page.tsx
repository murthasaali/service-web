...
export const metadata: Metadata = {
	...
	description:
		'Customer experience management services including CRM implementation, database cleanup, and omnichannel communication setup. HubSpot, Salesforce, Zoho integration for UK and India businesses.',
	keywords: [
	...
	alternates: {
		canonical: 'https://aibizmod.com/services/customer-exp-management',
	},
	openGraph: {
		title: 'Customer Experience Management Services | CRM Setup | aibizmod',
		description:
			'CRM implementation, database cleanup, and omnichannel communication setup with HubSpot, Salesforce, and Zoho integration.',

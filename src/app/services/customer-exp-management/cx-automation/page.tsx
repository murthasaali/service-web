...
export const metadata: Metadata = {
	...
	description:
		'Customer experience automation services. Workflow automation, AI chatbots, and voice agents that handle repetitive interactions at scale.',
	keywords: [
		'CX automation',
		'customer automation',
		'AI chatbots',
	...
	alternates: {
		canonical:
			'https://aibizmod.com/services/customer-exp-management/cx-automation',
	},
	openGraph: {

...
const serviceCards: ServiceCard[] = [
  {
    ...
    imageAlt: "Web developer designing a modern, responsive user interface layout on a laptop.",
  ...
  },
  {
    ...
    imageAlt: "Cloud server rack representing backend database API integrations and server hosting infrastructure.",
  ...
  },
  {
    ...
    imageAlt: "Computer screen displaying programming code for custom full-stack web application development.",
  ...
  },
  {
    ...
    imageAlt: "Customer making a mobile transaction at a credit card terminal for e-commerce.",
  ...
  },
  {
    ...
    imageAlt: "Desk setup with laptop and notepad representing headless CMS content management integration.",
  ...
  },
  {
    ...
    imageAlt: "Analytics dashboard detailing page speed and search engine optimization audit metrics.",

...
const serviceCards: ServiceCard[] = [
  {
    ...
    imageAlt: "Planet earth with glowing network lines representing enterprise cloud solutions infrastructure.",
  ...
  },
  {
    ...
    imageAlt: "Lines of continuous integration CI/CD code mapping automation pipelines on screen.",
  ...
  },
  {
    ...
    imageAlt: "Secure cloud server racks inside datacenter for hosting infrastructure operations.",
  ...
  },
  {
    ...
    imageAlt: "Professional workspace desk setup showing laptop and storage hosting devices.",
  ...
  },
  {
    ...
    imageAlt: "Digital security lock interface overlaid on abstract binary code pattern representation.",
  ...
  },
  {
    ...
    imageAlt: "Server room racks and cables showing structured database hardware server services.",

...
const serviceCards: ServiceCard[] = [
  {
    ...
    imageAlt: "Smartphone showing custom mobile application interfaces for iOS and Android native apps.",
    bullets: ["Android", "iOS"],
  ...
  },
  {
    ...
    imageAlt: "Developer code editor displaying Flutter programming code for cross-platform app deployment.",
  ...
  },
  {
    ...
    imageAlt: "Workspace team discussing enterprise software interface specifications and operations dashboards.",
  ...
  },
  {
    ...
    imageAlt: "User browsing an online store on a consumer application interface.",
  ...
  },
  {
    ...
    imageAlt: "Close-up of server data wires representing backend databases and API architecture.",
  ...
  },
  {
    ...
    imageAlt: "Software developers debugging application telemetry data on multiple computer screens.",

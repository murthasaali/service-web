...
const serviceCards: ServiceCard[] = [
  {
    ...
    imageAlt: "Search engine optimization keyword mapping documents and laptop analytics graph on a desk.",
  ...
  },
  {
    ...
    imageAlt: "PPC search engine marketing campaign setup panel on computer monitor screen.",
  ...
  },
  {
    ...
    imageAlt: "Tablet displaying social media marketing analytics dashboard data on user engagement.",
  ...
  },
  {
    ...
    imageAlt: "Close-up of hand writing blog articles and content marketing copywriting in a notebook.",
  ...
  },
  {
    ...
    imageAlt: "Customer receiving direct email marketing lifecycle promotions on a smartphone screen.",
  ...
  },
  {
    ...
    imageAlt: "Detailed web conversion rate analytics dashboard in Google Analytics 4.",

...
const serviceCards: ServiceCard[] = [
  {
    ...
    imageAlt: "Analytics chart showing user growth metrics and enterprise CRM system dashboard data.",
  ...
  },
  {
    ...
    imageAlt: "Notes and calendar planning pages detailing project workflow automation solutions.",
  ...
  },
  {
    ...
    imageAlt: "Industrial robot arm executing assembly tasks representing custom manufacturing software systems.",
  ...
  },
  {
    ...
    imageAlt: "Printed circuit board close-up representing legacy system modernization and integration.",
  ...
  },
  {
    ...
    imageAlt: "Product designer wireframing user interfaces for a new SaaS application development.",
  ...
  },
  {
    ...
    imageAlt: "Workspace with code editor showing setup and architecture mapping for IT consulting services.",
